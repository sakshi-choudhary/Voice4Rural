...
function useNumberInput(props) {
  ...
  var _props = props,
      ...
      name = _props.name,
      htmlProps = _objectWithoutPropertiesLoose(_props, ["focusInputOnChange", "clampValueOnBlur", "keepWithinRange", "min", "max", "step", "isReadOnly", "isDisabled", "getAriaValueText", "isInvalid", "pattern", "inputMode", "allowMouseWheel", "id", "onChange", "precision", "name"]);
  /**
