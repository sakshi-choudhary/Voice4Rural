...
export declare function getIsRtl(props: Dict): boolean;
...
declare function directionality<T extends Dict = Dict>(options: T): {
    getFourCornerValue: (value: string) => string;
